...
const FEED_URL = `https://s8seer.github.io/atom.xml`;
const FEED_DISPLAY = document.getElementById('latestUpdate')
...
fetch(FEED_URL)
    ...
    .then(data => {
        ...
        let html = `
                <b>${dateParser(data.querySelector("updated").innerHTML).toLocaleDateString("en-US", date_options)}</b>:
